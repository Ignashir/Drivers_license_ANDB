...
def draw_grid():
    ...
    for i, day in enumerate(DAYS):
        ...
        screen.blit(date_text, (x + COL_WIDTH//2 - date_text.get_width()//2, ROW_HEIGHT + 5))

        day_text = FONT.render(day, True, (0, 0, 0))
        screen.blit(day_text, (x + COL_WIDTH//2 - day_text.get_width()//2, ROW_HEIGHT + 25))
